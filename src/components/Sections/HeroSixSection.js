        ...
        <Row className={classes.row_content}>
          ...
          >
            <div className={`${classes.text_div} px-2`}>
              <h4 className={classes.header_text}>John</h4>
              <p className={classes.text_location}>california state</p>
              <p className={classes.text_content}>
                With a Homefood Eats meal, you can serve delectable, home-cooked
          ...
          >
            <div className={`${classes.text_div} px-2`}>
              <h4 className={classes.header_text}>Smith</h4>
              <p className={classes.text_location}>Florida state</p>
              <p className={classes.text_content}>
                {" "}
          ...
          >
            <div className={`${classes.text_div} px-2`}>
              ...
              <p className={classes.text_location}>Georgia state</p>
              <p className={classes.text_content}>
                No need to worry about any of this anymore with your app. Homefood
